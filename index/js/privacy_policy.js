...
$('#display_language').on('change', (e) => {
  if ($('#display_language').prop('checked')) {
    ...
    $('header .header_2windows nav ul li.3d_art a').attr('href', '../3d_art/3d_art_eng.html');
    $('header .header_2windows nav ul li.3d_art .text').text(' 3D Art Simulator for Buildings');
    ...
    $('header .header_form nav ul li.3d_art a').attr('href', '../3d_art/3d_art_eng.html');
    $('header .header_form nav ul li.3d_art .text').text(' 3D Art Simulator for Buildings');
  ...
  if (!$('#display_language').prop('checked')) {
    ...
    $('header .header_2windows nav ul li.3d_art a').attr('href', '../3d_art/3d_art.html');
    $('header .header_2windows nav ul li.3d_art .text').text(' 建築・3Dピクセルアート用シミュレーター');
    ...
    $('header .header_form nav ul li.3d_art a').attr('href', '../3d_art/3d_art.html');
    $('header .header_form nav ul li.3d_art .text').text(' 建築・3Dピクセルアート用シミュレーター');
